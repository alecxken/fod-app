...
@section('content')
        ...
        <div class="col-md-12" >
          <div class="row">
            ...
            <div class="row align-items-center">
              <div class="col">
                <h3 class="page-title">Organizations Section</h3>
                <ul class="breadcrumb">
                  <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                  <li class="breadcrumb-item active">Organizations Section</li>
                </ul>
              </div>
              <div class="col-auto float-right ml-auto">
                 <a  class="btn add-btn"  href="" data-toggle="modal" data-target="#add_ngo"><i class="fa fa-plus"></i> Register New NGO</a>
    ...
    <div class="card card-success">
        <div class="card-header ">
            <p class="card-title  ">Registered Organization </p>
         </div> 
        <div class="card-body">    
...
@push('scripts')
 ...
 @include('company.modalcreate')
 
 @include('company.modaledit')
<script>
$(function() {
    $('#users-table').DataTable({
        ...
        columns: [
            ...
            { data: 'rep_phone_number', name: 'rep_phone_number' },
