              ...
              <div class="col-xl-8 stretch-card grid-margin">
                <div class="position-relative">
                  ...
                  <div class="banner-content">
                    ...
                    <h1 class="mb-0">ECOBANK UPDATES</h1>
                    <h1 class="mb-2">
                     {{$cover->name ?? '' }}
                    </h1>
                    <div class="fs-12">
                  ...
                  <div class="banner-content">
                    <div class="badge badge-danger fs-12 font-weight-bold mb-3">
                      EKE No News updates yet
                    </div>
                    <h1 class="mb-0">ECOBANK CX  </h1>
                    <h1 class="mb-2">
                     Lets Stand Out
                    </h1>
                    <div class="fs-12">
              ...
              <div class="col-xl-4 stretch-card grid-margin">
                <div class="card bg-dark text-white">
                  <div class="card-body">
                    ...
                    >
                      <div class="pr-3">
                        <h5>OLA Energy partners with Ecobank to offer digital financial services at its stations across Africa</h5>
                        <div class="fs-12">
                    ...
                    >
                      <div class="pr-3">
                        <h5>Ecobank Transnational Incorporated Lists On LSE For US$350M</h5>
                        <div class="fs-12">
                    ...
                    >
                      <div class="pr-3">
                        <h5>AUDA-NEPAD and Ecobank Group partnership moves to finance phase under the 100,000 MSMEs Initiative</h5>
                        <div class="fs-12">
